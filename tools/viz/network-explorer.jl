...
begin
	...
	using DataFrames, CSV, Statistics, Revise, PlutoUI, HypertextLiteral
...
begin
	...
	@htl("""Select plot: $picker""")
end

# ╔═╡ 592f98f7-5cc1-448b-aa7d-0d7a0be98835
begin
	specs = Dict(
		"bySte" => Specs.pltTractsAndAPsBySte(ns, dsgAPs, fips),
		"byCty" => Specs.pltTractsAndAPsByCty(ns, dsgAPs, fips, ctys),
